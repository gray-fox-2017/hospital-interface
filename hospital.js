...
// Controller
let hospital = new Hospital ('Karunia Bunda', 'Bekasi');
let doctor = new Employee ('Dr.Bejo', 'Doctor', 'Bejo', 'bejo123');
...
rl.setPrompt(`===================================================\nWelcome to ${hospital.name} Hospital\nJl.Jatiwaringin,Pondok Gede,17411\n===================================================\nPlease enter your username:\n`);
rl.prompt();

rl.on('line', (answer) => {
  if (answer === 'Bejo' || answer === 'admin') {
    identity.push(answer);
  }
  if (identity[0] === 'Bejo' || identity[0] === 'admin') {
    if (stage === 0) {
      stage = 1;
